                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: DrinkSize.values.map((e) {
                        ...
                        return ChoiceChip(
                          label: Text(_sizeLabel(e), style: TextStyle(fontWeight: isSelected ? FontWeight.bold : FontWeight.normal)),
                          selected: isSelected,
                    ...
                    Wrap(
                      ...
                      children: SugarLevel.values.map((e) {
                        ...
                        return ChoiceChip(
                          label: Text(_sugarLabel(e), style: TextStyle(fontWeight: isSelected ? FontWeight.bold : FontWeight.normal)),
                          selected: isSelected,
                    ...
                    ...AddOn.values.map((a) => Card(
                          ...
                          shape: RoundedRectangleBorder(
                            ...
                            side: BorderSide(
                                color: addOns.contains(a) ? Theme.of(context).primaryColor : Colors.grey[300]!,
                                width: addOns.contains(a) ? 2 : 1),
                          ),
                          child: CheckboxListTile(
                            value: addOns.contains(a),
                            contentPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: 4),
                            title: Text(a.name, style: TextStyle(fontWeight: addOns.contains(a) ? FontWeight.bold : FontWeight.normal)),
                            subtitle: const Text('+₱20'),
                            activeColor: Theme.of(context).primaryColor,
                            onChanged: (_) => setState(() => addOns.contains(a) ? addOns.remove(a) : addOns.add(a)),
                          ),
                        )),
                    const SizedBox(height: 24),
